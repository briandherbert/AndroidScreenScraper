...
public class ImageTransmogrifier implements ImageReader.OnImageAvailableListener {
    static String TAG = ImageTransmogrifier.class.getSimpleName();
    ...
    ImageTransmogrifier(Activity activity, Handler handler) {
    ...
    public void onImageAvailable(ImageReader reader) {
        ...
        if (image != null) {
            ...
            ((ImageTransmogrifier.Listener)mActivity).updateImage(newPng);
        }
    }
